...
INSERT INTO `user_base` (`id`, `name`, `mobile_phone`, `uni_push_cid`, `create_time`, `modify_time`, `is_remove`) VALUES (null, 'test', '1', '', now(), now(), 0);
...
INSERT INTO `user_password` (`id`, `password`, `salt`, `length`, `user_id`) VALUES (null, '77d3b7ed9db7d236b9eac8262d27f6a5', '123', 6, 1);
