package cn.fudges.server.business.common.service.impl;
...
import cn.fudges.server.business.common.service.ConfigureService;
...
public class ConfigureServiceImpl implements ConfigureService {
    ...
    public Configuration index(HttpServletRequest request, Long userId) {
        ...
        configuration.setMobileSupport(projectConfigProperties.getSupport().getMobile());
